...
<html lang="en">
    ...
    <body>
        ...
        <main>            
            ...
            <!--Este <div></div> contiene el formulario para registrar los datos del usuario.-->
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <button class="btn btn-secondary" id="botonBuscar1" onclick="verificarNombreCorreoElectronico('NOMBRE')" type="button"><i class="fa-solid fa-magnifying-glass"></i></button>       
                        </div> 
                        ...
                        <button class="btn btn-outline-success" disabled id="botonRegistrar" onclick="registrarUsuario()" type="button"><b>REGISTRAR</b> <i class="fa-solid fa-floppy-disk"></i></button>                        
